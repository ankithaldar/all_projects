...
def get_loggers():
  return [
    Logger(
      ...
      init_args={'entity': None, 'project': 'kaggle_severstal', 'name': 'efficientnet_b1_01', 'tags': ["baseline", "debug"], 'notes': None, 'group': None, 'job_type': 'train', 'save_dir': "logs/wandb", 'save_code': False, 'offline': False, 'log_model': False}
    ),
    Logger(
