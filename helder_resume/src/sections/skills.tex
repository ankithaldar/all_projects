\section{Skills}
  \begin{itemize}[leftmargin=0.1in, label={}]
    \normalsize{\item{
      ...
      \textbf{Frameworks}: Git, GitHub, Gitlab, Apache Airflow/Google Composer, Google Office Suites, MS Office Suites, Google Cloud Platform \\
      \textbf{Libraries}: Pandas, NumPy, Matplotlib, Scrapy, Kedro, Scikit-Learn, CatBoost, XGboost, Statmodels, Seaborn, Sqlite3, Cx-Oracle, Selenium \\
