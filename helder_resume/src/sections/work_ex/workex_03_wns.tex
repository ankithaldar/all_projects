\resumeSubheading
  ...
  \resumeItemListStart
    ...
    \resumeItem{Evaluated potential drawbacks of the Loyalty team's collaboration with an insurance-based third-party service, which set up the grounds for renegotiating their deal, saving up to £2.5M annually}
    ...
    \resumeItem{Used ARIMA and Exponential Smoothing models to determine baseline sales \& assess the incremental impact of the launch of Red cups during the Holiday season (UK market)}
    ...
    \resumeItem{Create a fully automated data extractor \& feeder by scraping data for franchises from multiple websites using \textbf{python selenium}.}
