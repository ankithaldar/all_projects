...
def render_comparison_page(
    ...
    if ga_log:
        ...
        fig = go.Figure()
        fig.add_trace(go.Scatter(x=gens, y=best_costs, name="Best Cost", mode="lines"))
        fig.add_trace(go.Scatter(x=gens, y=best_times, name="Best Time", mode="lines"))
        fig.add_trace(go.Scatter(x=gens, y=best_wastes, name="Best Waste", mode="lines"))
        fig.update_layout(
            height=400,
            margin=dict(l=0, r=0, t=30, b=0),
